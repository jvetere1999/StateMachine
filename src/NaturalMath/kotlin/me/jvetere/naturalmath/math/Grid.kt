package me.jvetere.naturalmath.math

import java.util.stream.IntStream.range

data class Grid( val xMax: Int, val yMax: Int, var function: ExpressionFunction?) {
    //TODO Back to private user doesnt need to see
    private var grid:Array<BooleanArray> = Array(yMax) { BooleanArray(xMax) }
...
//            }
    ...
    operator fun invoke(): Array<BooleanArray> {
        return grid
    }
